			...
			<div class="main">
				...
				<div class="content">
						...
						<form>
								<div class="policy_txt policy">
									<div>
										...
										<br>
										<h4>제1조(목적)</h4>
										이 약관은 ㈜피투피시스템즈(이하 ‘회사’ 또는 ‘코스모스’라 합니다.)가 이 제공하는 모든 서비스(이하 ‘서비스’라
										합니다.)와 관련하여 정당한 방법으로 이용함에 있어 필요한 이용 조건, 절차 및 당사자간의 권리, 의무 등
										기본적인 사항을 규정하는 것을 목적으로 합니다.<br /> <br />

										<h4>제2조(용어의 정의)</h4>
										본 약관에서 사용하는 용어는 다음과 같이 정의합니다. <br> ① 서비스: 코스모스의 브랜드를 사용하는
										온라인과 오프라인을 포함하는 모든 상품 및 서비스를 말하며, 회사가 제공한 API를 이용하여 제3자가 개발 또는
										구축한 프로그램이나 서비스를 통하여 고객 또는 회원에게 제공되는 경우를 포함합니다.<br> ② 코스모스
										멤버십 회원: (이하 ‘회원’이라 합니다.) 코스모스 멤버십 또는 서비스 사이트를 통해 본 약관 제 6 조에 정해진
										회원가입 절차에 따라 가입하여 정상적으로 서비스를 이용할 수 있는 권한을 부여 받은 고객을 말하며, 회원은
										일반회원과 기업회원으로 구분됩니다.<br> ③ 사이트: 코스모스가 운영하는 브랜드들의 사이트를 말하며,
										이는 총 4개의 사이트로 구성되어 있습니다.<br> ④ 고객: 코스모스 멤버십 및 회사가 제공하는 서비스를
										이용하는 회원 또는 비회원을 말합니다. <br> ⑤ 아이디(ID): (이하 “아이디” 또는 “계정”이라
										합니다.) 회원식별과 회원의 서비스 이용을 위하여 코스모스 멤버십 및 사이트를 통해 회원이 입력하고 회사가 승인하는
										이메일(E-Mail)형식의 문자와 숫자의 조합을 의미합니다.<br> ⑦ 코스모스 지점 및 센터: (이하
										“지점”이라 합니다.) 코스모스 브랜드를 사용하는 모든 직영, 위탁 지점 및 프랜차이즈 계약을 통해 운영되는 전
										센터를 말합니다.<br> ⑧ 직원 및 운영자: (이하 “운영자”라 합니다.) 코스모스 멤버십 또는 지점
										...
										통보 <br> ④ -코스모스 멤버십 앱 Push, 공지사항 <br> ⑤ -휴대전화 메시지(SMS,
										...
										<h4>제5조(서비스 개요)</h4>
										① 회사가 본 약관에 정해진 바에 따라 멤버십 회원에게 코스모스가 제공하는 사이트의 주요 서비스 항목은 아래와
										같습니다.<br /> 가. 코스모스 사이트><br /> 회사가 제공하는 브랜드에 대한 설명과 공간 정보 제공 및
										검색, 예약과 관련된 전반적인 기능을 제공합니다.<br /> <br /> 나. 코스모스 모임센터 사이트<br />
										코스모스 모임센터 소개를 비롯하여 모임센터의 공간 정보 제공 및 검색, 예약과 관련된 전반적인 기능을 제공합니다.<br />
										<br /> 다. 코스모스 스터디센터 사이트<br /> 코스모스 스터디센터 소개를 비롯하여 스터디센터의 공간 정보
										제공 및 검색, 예약과 관련된 전반적인 기능을 제공합니다.<br /> <br /> 라. 코스모스 워크센터 사이트<br />
										코스모스 워크센터 소개를 비롯하여 워크센터의 공간 정보 제공 및 검색, 예약과 관련된 전반적인 기능을 제공합니다.<br />
										...
										미풍약속을 저해할 수 있는 목적으로 신청한 경우 <br /> ③ 코스모스 멤버십 회원과 서비스 이용에 따른
										...
										도용한 경우<br /> 나. 고객이 부정적립, 부정사용 등 코스모스 멤버십의 포인트 및 쿠폰을 부정한 방법 또는
										...
										다. 회원이 사망한 경우<br /> 라. 코스모스 및 지점의 서비스 이용을 부당하게 방해하거나 그 정보를 도용하는
										...
										① 회사는 서비스를 운영함에 있어 회사의 서비스 관련 각종 정보 및 광고를 사이트와 코스모스 멤버십 앱을 포함한
					...
					<div class="btnBox inner">
						<button type="button" class="btn defaultBtn goJoin">다음</button>
						<button type="button" class="btn defaultBtn" onclick="javascript:history.back();">취소</button>
					</div>
				</div>
			</div>
		</div>
